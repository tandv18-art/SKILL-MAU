...
const server = http.createServer(async (req, res) => {
  try {
    ...
    const message = req.url === '/api/world-checkin' ? 'World check-in generation failed.' : req.url === '/api/premium-portrait-enhancer' ? 'Portrait enhancement failed.' : 'Product photo generation failed.';
