...
const TEXT_GROUNDING_POLICY = `This source-bound factual-grounding rule is non-overridable. User-provided facts are the ONLY source for factual claims and domain-specific substance. Do not fill missing facts from general knowledge, common practice, probability, typical industry behavior, or plausible examples. If the user requests a factual list—such as mistakes, methods, requirements, documents, or criteria—but does not supply the actual items, use a clearly generic non-domain-specific framework or state that specific source facts are required. If a requested factual list cannot be produced from supplied facts, do not fabricate list items. Unless explicitly supplied, never name or assert exams, documents, essays or personal statements, recommendation letters, school, visa, or financial requirements, deadlines, fees, approval or rejection outcomes, penalties, statistics, eligibility rules, policies, guarantees, promotions, testimonials, certifications, or business facts. Do not infer consequences such as rejection, delay, lost points, or disqualification. Do not invent CTA offers or service promises such as sending a checklist, consultation, or inbox support. Creative wording may improve presentation only; it may not create factual substance. Preserve every user-supplied name, number, claim, and constraint. The individual skill instructions control format and style only; this shared rule controls factual grounding.`;
