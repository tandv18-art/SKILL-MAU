const PLAN_POLICIES = Object.freeze({
  // Final quota-only model. One successful generation = one unit.
  // Paid-plan limits are per 30-day billing period; Free image trial is lifetime.
  free: Object.freeze({ textMonthly: 10, imageMonthly: 0, imageLifetime: 3 }),
